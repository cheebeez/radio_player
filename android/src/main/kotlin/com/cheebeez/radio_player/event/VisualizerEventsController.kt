...
object VisualizerEventsController : EventChannel.StreamHandler {
    ...
    fun attach(messenger: BinaryMessenger) {
        ...
        eventChannel = EventChannel(messenger, "radio_player/visualizerEvents")
    ...
    /// Sends a data to Flutter, ensuring it's called on the main thread.
    fun sendData(data: List<Int>) {
